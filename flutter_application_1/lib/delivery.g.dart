...
class Delivery extends _i1.GeneratedContract {
  ...
  Future<List<dynamic>> getMessage(
    BigInt _orderId,
    _i1.EthereumAddress caller, {
    _i1.BlockNum? atBlock,
  }) async {
    final function = self.abi.functions[11];
    assert(checkSignature(function, '1b9ea3e4'));
    final params = [
      _orderId,
      caller,
    ];
